...
| Domain | Mastery           | Type | Slots | Effect                                                       |
| ------ | ----------------- | ---- | ----- | ------------------------------------------------------------ |
| Magic  | Rend Art          | MIND | 1     | Gain access to the **Rend** Art for spellcasting.            |
| Magic  | Afflict Art       | MIND | 1     | Gain access to the **Afflict** Art for spellcasting.         |
| Magic  | Bolster Art       | MIND | 1     | Gain access to the **Bolster** Art for spellcasting.         |
| Magic  | Mend Art          | MIND | 1     | Gain access to the **Mend** Art for spellcasting.            |
| Magic  | Ignis Resonance   | MIND | 1     | Gain access to the **Ignis** Resonance for spellcasting.     |
| Magic  | Mens Resonance    | MIND | 1     | Gain access to the **Mens** Resonance for spellcasting.      |
| Magic  | Terra Resonance   | MIND | 1     | Gain access to the **Terra** Resonance for spellcasting.     |
| Magic  | Lux Resonance     | MIND | 2     | Gain access to the **Lux** Resonance for spellcasting.       |
| Magic  | Tempus Resonance  | MIND | 2     | Gain access to the **Tempus** Resonance for spellcasting.    |
| Magic  | Cone Shaping      | MIND | 1     | You may use the **Cone N** special area shape when shaping your spells. |
| Magic  | Line Shaping      | MIND | 1     | You may use the **Line** special area shape when shaping your spells. |
| Magic  | Wall Shaping      | MIND | 1     | You may use the **Wall N** special area shape when shaping your spells. |
| Magic  | Salvo Shaping     | MIND | 1     | You may use the **Salvo N** special area shape when shaping your spells. |
| Magic  | Reflexive Casting | MIND | 1     | Spells you cast with the **Melee 1** tag gain the **Reflexive** tag: you may cast such a spell as a **Forestall** reaction when a creature within your melee range attempts to move, paying the spell's full Vigor cost in place of Forestall's usual cost. |
| Magic  | Sustained Casting | MIND | 1     | Gain the **Sustained Casting** maneuver (Vigor 1):<br />Extend one of your active spells' durations by **1 round**, paid separately for each spell you sustain. (Without this mastery, all duration Vigor must be committed at casting time via the Duration ladder.) |
...
| Domain  | Mastery       | Type | Slots | Effect                                                       |
| ------- | ------------- | ---- | ----- | ------------------------------------------------------------ |
| Scholar | Analyze       | MIND | 1     | Gain the **Analyze** maneuver (Vigor 2):<br />Target a creature in line of sight and make a **REA action roll**:<br />0-1s: Learn the target's Max Vitality + Wound slots, OR its Max Strain + Burden slots (your choice).<br />2s: Learn both of the above.<br />3+: Both of the above, plus one notable feature (a resistance, a weakness, a Signature attack, etc. — GM picks the most useful). You may re-Analyze a target to attempt a higher band; pay the Vigor cost each attempt. |
| Scholar | Arcane Shield | MIND | 1     | Gain the **Arcane Shield** reaction (Vigor 1):<br />Trigger: another creature targets you with an attack (declared before the attacker rolls). Effect: gain **resistance** to the triggering attack. You take **2 Strain**. |
...
| Domain | Mastery          | Type | Slots | Effect                                                       |
| ------ | ---------------- | ---- | ----- | ------------------------------------------------------------ |
| Human  | Aggression       | SOUL | 1     | Gain +1 BODY mastery slot.                                   |
| Human  | Brazenface       | BODY | 1     | Gain +1 MIND mastery slot.                                   |
| Human  | Iron Will        | SOUL | 1     | +2 Max Strain. Gain the **Iron Will** reaction (Vigor 1):<br />Trigger: When you are about to take Strain from an incoming attack. Effect: Halve the Strain that you take. |
| Human  | Mind Over Matter | MIND | 1     | Gain +1 BODY mastery slot.                                   |
...
| Elf    | Umbral Sight   | BODY | 1     | Gain **Darkvision**. Supersedes Low-Light Vision.            |
...
| Domain | Mastery                 | Type | Slots | Effect                                                       |
| ------ | ----------------------- | ---- | ----- | ------------------------------------------------------------ |
| Dwarf  | Ancestral Encouragement | SOUL | 1     | While you have the **Faltering** condition, gain **+1d bonus** on all attacks and reactive defenses. |
| Dwarf  | Dwarven Doughtiness     | SOUL | 1     | At the end of your turn, automatically clear the **Frightened** condition if you have it. |
| Dwarf  | Dwarven Hoard           | BODY | 1     | +1 gear slot.                                                |
| Dwarf  | Grudge-Keeper           | MIND | 1     | When a creature damages you, you may declare it your **Grudge**: gain **+1d** on attacks and opposing rolls against that creature for the rest of the encounter. Only one Grudge at a time; declaring a new one ends the previous. |
| Dwarf  | Stoneskin               | BODY | 1     | Gain **Resistance (Crushing)**.                              |
...
| Human Excellence     | Aggression, Mind Over Matter, Sophistry, Brazenface          | Gain **+1 Max Strain** per Human-domain mastery equipped.    |
| Enlightenment        | Sophistry, Brazenface, Open Mind, Self-Examination           | Gain **+1 Wildcard mastery slot** per 3 Human-domain masteries equipped (round down). |
| Bloodbath            | Bloodlust, Bloodfeast, Bloody Armor, Blood Scent             | Whenever an effect of yours would apply a **Wracked (Bleeding)** stack to a creature — even if the target is already at maximum stacks — regain **+2 Vigor**. While at least one creature within 5 squares of you has Wracked (Bleeding), gain **+1 Guard**. This can result in Over-Guard. |
